...
sub _and($) { $_[0] & native_to_latin1("+0") }
sub _oar($) { $_[0] | native_to_latin1("+0") }
sub _xor($) { $_[0] ^ native_to_latin1("+0") }
is _and native_to_latin1("waf"), native_to_latin1('# '),  'str var & const str'; # [perl #20661]
is _and native_to_latin1("waf"), native_to_latin1('# '),  'str var & const str again'; # [perl #20661]
is _oar native_to_latin1("yit"), native_to_latin1('{yt'), 'str var | const str';
is _oar native_to_latin1("yit"), native_to_latin1('{yt'), 'str var | const str again';
is _xor native_to_latin1("yit"), native_to_latin1('RYt'), 'str var ^ const str';
is _xor native_to_latin1("yit"), native_to_latin1('RYt'), 'str var ^ const str again';
